...
class ClassSessionExpanderTest {
    ...
    @Test fun expandsWeeksIntoDatedClassSessionsWithTopic() {
        ...
        assertTrue(week1.all { it.title == "Presentación del curso y Elementos básicos de Computación" })
    ...
    @Test fun mixedTopicCellStripsEmbeddedFeriadoFromTitleButKeepsWeek() {
        ...
        assertTrue(drafts.all { it.title == "Elementos básicos de programación orientada a objetos (POO)" })
    ...
    @Test fun examAnnouncementIsStrippedFromClassTitle() {
        ...
        assertTrue(drafts.isNotEmpty())
        assertTrue(drafts.all { it.title == "Recapitulación y Práctica de Estructuras Condicionales, Iterativas y Funciones" })
    }
